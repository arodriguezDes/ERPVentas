...
<html>
    <head>
        ...
        <!-- Bootstrap CSS
        ============================================ -->
        <link rel="stylesheet" href="../public/plugins/css/_all-skins.min.css">
        <!-- SweetAlert2 -->
        ...
        <link rel="stylesheet" type="text/css" href="../public//plugins/bootstrap/css/bootstrap-select.min.css">
    </head>
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- Fin Menu Desplegable de Notificaciones -->
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline">Andres Rodriguez</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <!-- User image -->
                            <li class="user-header bg-primary" style="height: 215px">
                                <img src="../public/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">

                                <p>
                                    <span class="hidden-xs">Andres Rodriguez</span>
                                <h6>www.GlobalSoft.com - Desarrollando Software</h6>              
                                <small>www.youtube.com/Globalsoft</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="#" class="btn btn-default btn-flat float-right">Desconectar</a>
                            </li>
                        </ul>
                    </li>
                    <!-- Fin Menu Desplegable de Usuario -->

                    <!-- Menu Desplegable de Configuraciones -->
                    <li class="nav-item">
                        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#">
                            <i class="fas fa-th-large"></i>
                        </a>
                    </li>
                    <!-- Fin Menu Desplegable de Configuraciones -->
                </ul>
            </nav>
            ...
            <!-- Contenedor de Menu principal Donde estan tados las opciones a los modulos -->
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Logotipo -->
                <a href="#" class="brand-link">
                    <img src="../public/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                         style="opacity: .8">
                    <span class="brand-text font-weight-light">ERPVentas</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="#" class="d-block">Andres Rodriguez</a>
                        </div>
                    </div>
